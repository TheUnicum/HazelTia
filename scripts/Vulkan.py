...
""" Non funziona il download per ragioni di accessi, scaricare manualmente il files : <VulkanSDK-1.2.170.0-DebugLibs.zip> """
...
def CheckVulkanSDKDebugLibs():
    ...
    if (not shadercdLib.exists()):
        ...
        with open("{}/{}".format(OutputDirectory, 'VulkanSDK-1.2.170.0-DebugLibs.zip'), 'rb') as zipresp:
