...
public:
		...
		: Layer("Example"), m_Camera(-1.6f, +1.6f, -0.9f, +0.9f), m_CameraPosition(0.0f)
	{
		...
		std::dynamic_pointer_cast<Hazel::OpenGLShader>(m_TextureShader)->UpdloadUniformInt("u_Texture", 0);
	}
	...
	void OnUpdate(Hazel::Timestep ts) override
	{
		...
		std::dynamic_pointer_cast<Hazel::OpenGLShader>(m_FlatColorShader)->UpdloadUniformFloat3("u_Color", m_SquareColor);
